...
const studentInformation = {
  ...
  graduationYear: "2024",
  imageUrl: "https://unsplash.com/photos/DndGvxWpAuY",
}
...
const domStudentGrade = document.querySelector("#student-grade");
...
const domStudentImg = document.querySelector("#student-image");
...
const winterSemester = document.querySelector("#winter-term");
...
function updateStudentName(studentName) {
    domStudentName.innerHTML = studentName;
}
...
function updateStudentGradeLevel(studentGradeLevel) {
    domStudentGradeLevel.innerHTML = studentGradeLevel; 
}
...
function updateStudentAdvisor(studentAdvisor) {
    domStudentAdvisor.innerHTML = studentAdvisor;
}
...
function updateMajor(studentMajor) {
    domStudentMajor.innerHTML = studentMajor;
}
...
function updateStudentGraduationYear(graduationYear) {
    domStudentGraduationYear.innerHTML = graduationYear;
}
...
function updateReportCard(reportCardTableElement, currentSemester) {
  ...
  updateDropdownLabel(currentSemester)
  ...
  courses.forEach(element => {
      let g = 0;
      addCourseRowToReportCard(reportCardTableElement, element, g);
      g++;
  });
 ...
 *
 */
function updateDropdownLabel(semester) {
...
window.onload = function () {
    ...
    addEventListeners(dropdownEl, dropdownIcon, reportCardTable, fallSemester, springSemester, winterSemester);
